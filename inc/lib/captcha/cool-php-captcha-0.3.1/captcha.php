...
class SimpleCaptcha {
	 ...
	 *
	 */
	public $resourcesPath = 'inc/lib/captcha/cool-php-captcha-0.3.1/resources';
	...
	function GetDictionaryCaptchaText($extended = false) {
		...
		$line   = mt_rand(1, (filesize($wordsfile)/$length)-2);
	...
	protected function WriteLine() {
		...
		$x2 = $this->textFinalX;
		$y1 = mt_rand($this->height*$this->scale*.40, $this->height*$this->scale*.65);
		$y2 = mt_rand($this->height*$this->scale*.40, $this->height*$this->scale*.65);
	...
	protected function WaveImage() {
		...
		$xp = $this->scale*$this->Xperiod*mt_rand(1,3);
		$k = mt_rand(0, 100);
